...
# localiser le bloc de classe kicad_default (depuis "(class kicad_default" jusqu'a la
# parenthese fermante correspondante)
...
# nettoyer les espaces multiples laisses par la suppression
...
# inserer juste apres le bloc kicad_default modifie
